...
public static void main(String[] args) throws Exception {
		...
		// Open web site
		 ...
		 //Find by Abs xpath
		    WebElement usernameXpath = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[3]/div[2]/div[2]/form[1]/div[2]/input[1]"));
            System.out.println("The Abs xpath of username fied is" + usernameXpath);
		    
		    WebElement passwordXpath = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/div[3]/div[2]/div[2]/form[1]/div[3]/input[1]"));
	    ...
	    //Find by cssSelector
		 ...
		 //Find by Tagname
		 // Field user name và password đều có tag name giống nhau nên ở đây em chỉ demo 1 field
